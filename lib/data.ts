...
export const services: Service[] = [
  ...
  },
  {
    ...
    products: [
      {
        name: "Hager Groepenkast 1-Fase",
        brand: "Hager",
        price: "Vanaf € 680,-",
        categoryId: "meterkast",
        description: "Compleet uitgeruste 1-fase groepenkast van topmerk Hager.",
        techSpecs: [
          "1-Fase hoofdschakelaar 40A",
          "2 Aardlekschakelaars 2P 40A",
          "Tot 8 groepen (B16)",
      ...
      {
        name: "Hager Groepenkast 3-Fase",
        brand: "Hager",
        price: "Vanaf € 850,-",
        categoryId: "meterkast",
        description: "Premium 3-fase groepenkast voor warmtepompen en laadpalen.",
        techSpecs: [
          "3-Fase hoofdschakelaar 40A",
          "3 Aardlekschakelaars 2P 40A",
          "Tot 12 groepen (B16)",
          "NEN 1010 gecertificeerd",
          "KEMA-KEUR gekeurd",
        ],
      ...
      {
        name: "ABB Hafonorm Groepenkast 3-Fase",
        brand: "ABB",
        price: "Vanaf € 890,-",
        categoryId: "meterkast",
        description: "Hoogwaardige ABB groepenkast met flexibel Busboard-systeem.",
        techSpecs: [
          "3-Fase hoofdschakelaar 40A",
          "3 Aardlekschakelaars 40A",
          "12 Flexomaten groepen",
          "Busboard uitbreidingssysteem",
          "NEN 1010 gecertificeerd",
        ],
        image: "/images/services/meterkast.webp",
      },
