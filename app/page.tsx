...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative bg-bg border-t border-hairline overflow-hidden py-24 lg:py-32">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <Reveal>
            <h2 className="flex items-center gap-3 mb-16 justify-center text-[10px] font-black uppercase tracking-[0.3em] text-ink">
